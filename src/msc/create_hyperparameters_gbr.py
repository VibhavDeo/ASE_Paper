...
param_dist = {
    ...
    'subsample': uniform(0.01, 1-0.01), 
    'criterion': ['friedman_mse', 'squared_error'],
    'min_samples_split': uniform(0.01, 0.999-0.01), 
    'min_samples_leaf': uniform(0.01, 0.5-0.01), 
    ...
    'init': [None, 'zero'],
    'max_features': ['sqrt', 'log2', uniform(0.01, 0.999-0.01)], 
    'alpha': uniform(0.01, 0.999-0.01),
    'max_leaf_nodes': [None, randint(2, 50)],
    'warm_start': [False, True],
    'validation_fraction': uniform(0.01, 0.999-0.01), 
